...
val md_theme_light_primaryContainer = Color(0xFF4789BD)//detalles
val md_theme_light_onPrimaryContainer = Color(0xFFFFFFFF)
val md_theme_light_secondary = Color(0xFF625B71)
val md_theme_light_onSecondary = Color(0xFFFFFFFF)
val md_theme_light_secondaryContainer = Color(0xFFE8DEF8)
val md_theme_light_onSecondaryContainer = Color(0xFF549EDA)
...
val md_theme_light_background = Color(0xFFDDA757)
...
val md_theme_light_surfaceVariant = Color(0xFF549AD1) // lista
